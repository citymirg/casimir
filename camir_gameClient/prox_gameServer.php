...
$_REQUEST['csurl'] = urlencode(MAINGAME_SERVER_PATH);
...
/*
 * Daniel Wolff: I edited this proxy
 * a. to have a fixed url
 * b. to always forward $get
 * c. to use the raw input stream as $post
 *
 * @todo: care for PHP injection
 */
...
if (count( $_GET ) > 0 && (!array_key_exists( 'query', $p_request_url ) || empty( $p_request_url['query'] ) ) ) {
